...
export default function CampsBayPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Camps Bay.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground">
              Beachside luxury mobile spa treatments delivered to your location
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Main Content */}
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Camps Bay</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Experience luxury mobile spa services in beautiful Camps Bay. Our professional 
                  therapists bring relaxation and rejuvenation directly to your home, hotel, or 
                  accommodation with stunning ocean views.
                </p>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Enjoy our full range of spa treatments in the comfort of your space, combining 
                  beachside relaxation with professional spa care.
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Camps Bay and surrounding areas.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-2">
                      Approximately 10 minutes from Cape Town CBD
                    </p>
                  </CardContent>
                </Card>
