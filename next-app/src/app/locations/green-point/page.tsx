...
export default function GreenPointPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Green Point.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Green Point</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Enjoy luxury mobile spa services in Green Point. Our professional therapists bring 
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  ...
                  convenient service to Green Point and surrounding areas.
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Green Point and surrounding areas.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-2">
                      Approximately 5 minutes from Cape Town CBD
                    </p>
                  </CardContent>
                </Card>
