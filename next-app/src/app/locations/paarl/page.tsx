...
export default function PaarlPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Paarl.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground">
              Luxury mobile spa treatments delivered to your location in the beautiful Winelands
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Main Content */}
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Paarl</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Indulge in luxury mobile spa services in Paarl. Our professional therapists bring 
                  relaxation and rejuvenation directly to your home, hotel, or accommodation in the 
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Paarl and surrounding areas including:
                    </p>
                    <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                      <li>• Central Paarl</li>
                      <li>• Paarl Winelands</li>
                      <li>• Paarl Valley</li>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-2">
                      Approximately 60 minutes from Cape Town CBD
                    </p>
