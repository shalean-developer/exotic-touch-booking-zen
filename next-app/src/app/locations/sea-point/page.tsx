...
export default function SeaPointPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Sea Point.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6 text-gradient-primary">
              Mobile Spa in Sea Point
            </h1>
            <p className="text-xl text-muted-foreground">
              Convenient mobile spa treatments delivered to your location
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Main Content */}
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Sea Point</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Enjoy luxury mobile spa services in Sea Point. Our professional therapists bring 
                  relaxation and rejuvenation directly to your home or accommodation in this vibrant 
                  coastal area.
                </p>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Experience our full range of spa treatments in the comfort of your space, with 
                  convenient service to Sea Point and surrounding areas.
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Sea Point and surrounding areas.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-2">
                      Approximately 8 minutes from Cape Town CBD
                    </p>
                  </CardContent>
                </Card>
