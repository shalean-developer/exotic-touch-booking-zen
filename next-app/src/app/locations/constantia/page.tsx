...
export default function ConstantiaPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Constantia.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Main Content */}
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Constantia</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Experience premium mobile spa services in Constantia. Our professional therapists 
                  bring luxury spa treatments directly to your home or hotel in this beautiful area.
                </p>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Enjoy our full range of spa treatments in the comfort of your own space, surrounded 
                  by the natural beauty of Constantia.
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Constantia and surrounding areas.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-2">
                      Approximately 15 minutes from Cape Town CBD
                    </p>
                  </CardContent>
                </Card>
