...
export default function MilnertonPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Milnerton.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Milnerton</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Experience luxury mobile spa services in Milnerton. Our professional therapists bring 
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  ...
                  service to Milnerton and surrounding areas.
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Milnerton and surrounding areas.
                    </p>
                  </CardContent>
                </Card>
