...
export default function StellenboschPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Stellenbosch.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6 text-gradient-primary">
              Mobile Spa in Stellenbosch
            </h1>
            <p className="text-xl text-muted-foreground">
              Luxury mobile spa treatments delivered to your location in the heart of the Winelands
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Our expert therapists travel to Stellenbosch and surrounding areas, bringing everything needed for 
                  a complete spa experience. No need to leave your comfort - we come to you!
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Stellenbosch and surrounding areas including:
                    </p>
                    <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                      <li>• Central Stellenbosch</li>
                      <li>• Stellenbosch Winelands</li>
                      <li>• Stellenbosch University Area</li>
                      <li>• Surrounding Estates</li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-2">
                      Approximately 45 minutes from Cape Town CBD
                    </p>
                    <p className="text-sm text-muted-foreground">
                      We schedule appointments to accommodate travel time to ensure you receive the full treatment duration.
                    </p>
                  </CardContent>
                </Card>
