...
export default function RondeboschPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Rondebosch.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Rondebosch</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Enjoy luxury mobile spa services in Rondebosch. Our professional therapists bring 
                  relaxation and rejuvenation directly to your home or accommodation in this beautiful 
                  Southern Suburbs area.
                </p>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Experience our full range of spa treatments in the comfort of your space, with 
                  convenient service to Rondebosch and surrounding areas.
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Rondebosch and surrounding areas.
                    </p>
                  </CardContent>
                </Card>
