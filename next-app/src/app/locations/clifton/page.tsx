...
export default function CliftonPage() {
  const whatsappUrl = "https://wa.me/27684984179?text=Hi! I'd like to book a spa treatment in Clifton.";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground">
              Exclusive mobile spa treatments delivered to your location
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-heading font-bold mb-6">Spa Services in Clifton</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Experience exclusive mobile spa services in Clifton. Our professional therapists bring 
                  luxury spa treatments directly to your home or accommodation in this prestigious 
                  beachside area.
                </p>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Enjoy our full range of spa treatments in the comfort of your space, with convenient 
                  service to Clifton and surrounding areas.
                </p>
                ...
                <Card className="luxury-card border-luxury">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      We service Clifton and surrounding areas.
                    </p>
                  </CardContent>
                </Card>
